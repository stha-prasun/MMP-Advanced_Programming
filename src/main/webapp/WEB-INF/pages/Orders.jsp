                            ...
                            <ul class="menu">
                                <li class="menu-item">
                                    <span class="menu-icon">
                                        <img src="<%= request.getContextPath() %>/Assets/Seller Product/product.png"
                                            alt="" />
                                    </span>
                                    My Products
                                </li>
                                <li class="menu-item">
                                    <span class="menu-icon">
                                        <img src="<%= request.getContextPath() %>/Assets/Seller Product/addPrd.png"
                                            alt="" />
                                    </span>
                                    Add Products
                                </li>
                                <li class="menu-item active">
                                    <span class="menu-icon">
                                        <img src="<%= request.getContextPath() %>/Assets/Seller Product/order.png"
                                            alt="" />
                                    </span>
                                    Orders
                                </li>
                    ...
                    <main class="main">
                        ...
                        <div class="navbar">
                            ...
                            <div class="navRight">
                                <div class="searchWrapper">
                                    <img class="searchIcon" src="<%= request.getContextPath() %>/Assets/Home/search.png"
                                        alt="" />
                        ...
                        <div class="editPadding">
                            <c:if test="${not empty orderList}">
                                <div class="contact">Track and manage your sales &bull; &nbsp;${fn:length(customers)}
                                    TOTAL ORDERS
                                </div>
                            </c:if>
                                        ...
                                        <div class="timeline-section">
                                            ...
                                            <div class="timeline-item">
                                                <div class="timeline-icon">
                                                    <img src="<%= request.getContextPath() %>/Assets/Seller Product/pending.png"
                                                        alt="" />
                                                </div>
                                ...
                                <div class="order-card expanded" id="order-2">
                                    ...
                                    <div class="order-details">
                                        ...
                                        <div class="timeline-section">
                                            ...
                                            <div class="timeline-item">
                                                <div class="timeline-icon">
                                                    <img src="<%= request.getContextPath() %>/Assets/Seller Product/completed.png"
                                                        alt="" />
                                                </div>
                                                <div class="timeline-content">
                                ...
                                <div class="order-card expanded" id="order-3">
                                    ...
                                    <div class="order-details">
                                        ...
                                        <div class="timeline-section">
                                            ...
                                            <div class="timeline-item">
                                                <div class="timeline-icon">
                                                    <img src="<%= request.getContextPath() %>/Assets/Seller Product/cancelled.png"
                                                        alt="" />
                                                </div>
                                                <div class="timeline-content">
