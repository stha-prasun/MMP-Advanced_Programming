...
<div class="container">
  ...
  <div class="left">
    ...
    <img src="<%= request.getContextPath() %>/Assets/Login/peep.svg" class="illustration">
  </div>
  ...
  <div class="right">
    <div class="form-box">
      ...
      <div class="password-wrapper">
        ...
        <img src="<%= request.getContextPath() %>/Assets/Login/view.png" id="togglePassword" class="eye-icon">
      </div>
