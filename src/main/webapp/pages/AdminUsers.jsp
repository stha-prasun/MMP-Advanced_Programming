    ...
    <aside class="sidebar">
      <nav class="nav">
        ...
        <a href="#" class="nav-item">
          <div class="nav-icon">
            <img src="<%= request.getContextPath() %>/Assets/Admin Dashboard/products.png" alt="User Avatar" />
         </div>
          PRODUCTS
        </a>
        <a href="#" class="nav-item">
          ...
          <li class="user-card">
            ...
            <div class="user-card-actions">
              <button class="btn-delete" aria-label="Delete user">
                <div >
                  <img src="<%= request.getContextPath() %>/Assets/Admin Dashboard/dustbin.png" alt="dustbin icon" style="width:16px; height:16px;">
                </div>
              </button>
            </div>
          </li>
